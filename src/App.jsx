  ...
  return (
    <div style={{ minHeight:"100vh", background:"#0e0e0e", color:"#e8e8e8", fontFamily:"'DM Sans','Noto Sans JP','Hiragino Kaku Gothic ProN',sans-serif", display:"flex", flexDirection:"column" }}>
      ...
      <div style={{ borderBottom:"1px solid #1c1c1c", padding:"14px 24px", display:"flex", alignItems:"center", gap:12 }}>
        <div style={{ fontFamily:"'DM Mono',monospace", fontSize:13, letterSpacing:"0.18em", color:"#444", flex:1 }}>
          CALENDAR
        </div>
        <div style={{ display:"flex", gap:8, alignItems:"center", position:"relative" }}>
          <button className="top-action-btn" onClick={() => { setViewYear(today.getFullYear()); setViewMonth(today.getMonth()); setSelected(todayStr); }}>
            TODAY
          </button>
      ...
      <div style={{ display:"flex", flex:1, maxWidth:900, margin:"0 auto", width:"100%", padding:"0 0 32px" }}>

        {/* Calendar */}
        <div style={{ flex:1, padding:"22px 20px" }}>
          <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:18 }}>
            <button className="nav-btn" onClick={prevMonth}>‹</button>
            <div style={{ flex:1, textAlign:"center", fontFamily:"'DM Mono',monospace", fontSize:14, letterSpacing:"0.16em", color:"#aaa" }}>
        ...
        {/* Sidebar */}
        <div style={{ width:248, padding:"22px 20px 22px 0" }}>
          {selected ? (
            <div>
              <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:12 }}>
                <div style={{ fontFamily:"'DM Mono',monospace", fontSize:12, color:"#555", letterSpacing:"0.1em" }}>
                  {selected.replace(/-/g,".")}
                </div>
                <button className="icon-btn" onClick={() => openAdd(selected)} title="追加" style={{ fontSize:16 }}>+</button>
              </div>
            ...
            <div className="sidebar-empty">SELECT A DATE</div>
          )}
        </div>
      </div>
